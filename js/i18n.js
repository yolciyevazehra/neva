...
const NEVA_I18N = {
  az: {
    ...
    "faq.description": "Rezervasiya, ödəniş və tərəfdaşlıq haqqında ən çox verilən suallara cavab tapdıq. Başqa sualın varsa, bizimlə əlaqə saxla.",
    "faq.q1": "Neva-da necə rezervasiya edə bilərəm?",
    "faq.a1": "Xidmətlər səhifəsində kateqoriya seç, xəritədə sənə ən yaxın olanı tap, biznesin profilinə keç, xidməti, tarixi və saatı seçib formu doldur — rezervasiyan anında təsdiqlənir.",
    "faq.q2": "Rezervasiyamı ləğv edə və ya dəyişə bilərəmmi?",
    "faq.a2": "Bəli. Görüş vaxtına ən azı 3 saat qalanadək rezervasiyanı hesabından pulsuz ləğv edə və ya yeni tarixə köçürə bilərsən.",
    "faq.q3": "Bir neçə şəxs üçün eyni anda rezerv etmək olarmı?",
    "faq.a3": "Restoran və kafelərdə masa tutarkən nəfər sayını seçə bilərsən; salon xidmətlərində isə hər nəfər üçün ayrıca rezervasiya tələb olunur.",
    "faq.q4": "Ödənişi harada edirəm?",
    "faq.a4": "Bəzi xidmətlərdə yerində, bəzilərində isə platforma üzərindən kartla ödəniş mümkündür. Bu, hər biznesin profilində qeyd olunur.",
    "faq.q5": "Rezervasiya üçün əvvəlcədən ödəniş tələb olunurmu?",
    "faq.a5": "Xeyr. Neva üzərindən rezervasiya etmək həmişə pulsuzdur — ödəniş yalnız aldığın xidmətin özünə görədir və birbaşa biznesə edilir.",
    "faq.q6": "Öz biznesimi Neva-ya necə əlavə edərəm?",
    "faq.a6": "Əlaqə səhifəsindəki formu doldur, komandamız 24 saat ərzində səninlə əlaqə saxlayıb profilini quracaq.",
    "faq.q7": "Tərəfdaşlıq üçün hansı sahələr uyğundur?",
    "faq.a7": "Hazırda gözəllik salonları, restoran və kafeləri qəbul edirik. Yeni sahələr tezliklə əlavə olunacaq.",
    "faq.q8": "Hesab yaratmadan rezervasiya edə bilərəmmi?",
    "faq.a8": "Bəli, qonaq olaraq rezerv edə bilərsən. Hesab yaratmaqla isə rezervasiya tarixçəni izləyə və daha sürətli rezervasiya edə bilərsən.",
    "faq.q9": "Şifrəmi unutmuşam, nə etməliyəm?",
    "faq.a9": 'Daxil ol səhifəsindəki "Şifrəni unutdum?" linkinə klik et. Bu, demo versiyada real e-poçt göndərmir — birbaşa dəstək komandamızla əlaqə saxlamağını göstərir.',
    ...
    "demo_recovery": "Demo rejimində şifrə bərpası yoxdur — dəstəklə əlaqə: nevacompanyy@gmail.com",
    "login.loginSub": "Rezervasiyalarına baxmaq üçün hesabına daxil ol","login.tabLogin":"Daxil ol","login.tabRegister":"Qeydiyyat","login.email":"E-poçt","login.pass":"Şifrə",
  ...
  ru: {
    ...
    "faq.description": "Мы собрали ответы на самые часто задаваемые вопросы о бронировании, оплате и партнёрстве. Если у вас есть другой вопрос, свяжитесь с нами.",
    "faq.q1": "Как забронировать услугу в Neva?",
    "faq.a1": "Выберите категорию на странице услуг, найдите ближайший бизнес на карте, откройте его профиль, выберите услугу, дату и время и заполните форму — бронирование будет подтверждено сразу.",
    "faq.q2": "Можно ли отменить или изменить бронирование?",
    "faq.a2": "Да. Вы можете бесплатно отменить бронирование или перенести его на другую дату через свой аккаунт не менее чем за 3 часа до встречи.",
    "faq.q3": "Можно ли забронировать услугу сразу для нескольких человек?",
    "faq.a3": "При бронировании столика в ресторане или кафе можно указать количество человек. Для услуг салона требуется отдельное бронирование для каждого человека.",
    "faq.q4": "Где производится оплата?",
    "faq.a4": "Некоторые услуги можно оплатить на месте, для других доступна оплата картой через платформу. Информация об этом указана в профиле каждого бизнеса.",
    "faq.q5": "Требуется ли предоплата за бронирование?",
    "faq.a5": "Нет. Бронирование через Neva всегда бесплатно — вы оплачиваете только полученную услугу непосредственно бизнесу.",
    "faq.q6": "Как добавить свой бизнес в Neva?",
    "faq.a6": "Заполните форму на странице контактов. Наша команда свяжется с вами в течение 24 часов и создаст ваш профиль.",
    "faq.q7": "Какие сферы подходят для партнёрства?",
    "faq.a7": "В настоящее время мы принимаем салоны красоты, рестораны и кафе. Новые категории будут добавлены в ближайшее время.",
    "faq.q8": "Можно ли забронировать услугу без создания аккаунта?",
    "faq.a8": "Да, вы можете забронировать услугу как гость. Создав аккаунт, вы сможете отслеживать историю бронирований и бронировать быстрее.",
    "faq.q9": "Я забыл(а) пароль. Что делать?",
    "faq.a9": 'Нажмите на ссылку «Забыли пароль?» на странице входа. В демо-версии настоящее электронное письмо не отправляется — вместо этого предлагается связаться с нашей службой поддержки.',
    ...
    "demo_recovery": "Восстановление пароля недоступно в демо-режиме — служба поддержки: nevacompanyy@gmail.com",
    "login.loginSub": "Войдите в свой аккаунт, чтобы просмотреть свои бронирования","login.tabLogin":"Войти","login.tabRegister":"Регистрация","login.email":"Эл. почта","login.pass":"Пароль",
  ...
  en: {
    ...
    "faq.description": "We have answered the most frequently asked questions about booking, payment, and partnerships. If you have another question, feel free to contact us.",
    "faq.q1": "How can I make a reservation on Neva?",
    "faq.a1": "Choose a category on the Services page, find the nearest business on the map, open its profile, select the service, date, and time, then fill out the form — your reservation will be confirmed instantly.",
    "faq.q2": "Can I cancel or change my reservation?",
    "faq.a2": "Yes. You can cancel your reservation for free or move it to another date from your account at least 3 hours before the appointment.",
    "faq.q3": "Can I make a reservation for several people at the same time?",
    "faq.a3": "When booking a table at restaurants and cafés, you can select the number of people. For salon services, a separate reservation is required for each person.",
    "faq.q4": "Where do I make the payment?",
    "faq.a4": "Some services can be paid for on-site, while others allow card payment through the platform. This information is shown on each business profile.",
    "faq.q5": "Is prepayment required for a reservation?",
    "faq.a5": "No. Making a reservation through Neva is always free — you only pay for the service you receive, directly to the business.",
    "faq.q6": "How can I add my business to Neva?",
    "faq.a6": "Fill out the form on the Contact page. Our team will contact you within 24 hours and set up your profile.",
    "faq.q7": "Which industries are eligible for partnership?",
    "faq.a7": "Currently, we accept beauty salons, restaurants, and cafés. New categories will be added soon.",
    "faq.q8": "Can I make a reservation without creating an account?",
    "faq.a8": "Yes, you can make a reservation as a guest. By creating an account, you can track your reservation history and make reservations faster.",
    "faq.q9": "I forgot my password. What should I do?",
    "faq.a9": 'Click the "Forgot password?" link on the login page. In the demo version, it does not send a real email — it directs you to contact our support team.',
    ...
    "demo_recovery": "Password recovery is not available in demo mode — contact support: nevacompanyy@gmail.com",
    "login.loginSub": "Log in to your account to view your reservations","login.tabLogin":"Log in","login.tabRegister":"Register","login.email":"Email","login.pass":"Password",
